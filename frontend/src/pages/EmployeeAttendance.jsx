        ...
        <div className={styles.topSection}>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.daySelector}>
              {["M", "T", "W", "T", "F", "S", "S"].map((d, i) => (
                <div
                  key={i}
                  className={`${styles.dayCircle} ${i === 5 ? styles.dayActive : ""}`}
                >
                  {d}
                </div>
              ))}
          ...
          <div className={styles.card}>
            ...
            <ul className={styles.actionList}>
              <li className={styles.actionItem} onClick={() => openCanvas("leave")}>
                <i className="bi bi-calendar2-check"></i> Apply Leave
              </li>
              <li className={styles.actionItem} onClick={() => openCanvas("wfh")}>
                <i className="bi bi-laptop"></i> Work From Home
              </li>
              <li className={styles.actionItem} onClick={() => openCanvas("partial")}>
            ...
            <table className={styles.dataTable}>
              ...
              <tbody>
                {attendanceData.map((row, idx) => (
                  <tr key={idx}>
                    <td>{row.date}</td>
                    <td>{row.visual && <div className={styles.progressBar2}></div>}</td>
            ...
            <form className={styles.canvasBody} onSubmit={handleSubmitRequest}>
              <div className={styles.dateBox}>
                <div>
                  ...
                  <input name="from" type="date" className={styles.dateInput} required />
                </div>
                <div className={styles.dayCount}>0 days</div>
                <div>
                  <p className={styles.inputLabel}>To</p>
                  <input name="to" type="date" className={styles.dateInput} required />
                </div>
              </div>
